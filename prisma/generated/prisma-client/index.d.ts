...
export interface Exists {
  ...
  weiter: (where?: WeiterWhereInput) => Promise<boolean>;
}
...
export interface Prisma {
  ...
  weiter: (where: WeiterWhereUniqueInput) => WeiterNullablePromise;
  weiters: (args?: {
    where?: WeiterWhereInput;
    orderBy?: WeiterOrderByInput;
    skip?: Int;
    after?: String;
    before?: String;
    first?: Int;
    last?: Int;
  }) => FragmentableArray<Weiter>;
  weitersConnection: (args?: {
    where?: WeiterWhereInput;
    orderBy?: WeiterOrderByInput;
    skip?: Int;
    after?: String;
  ...
  createWeiter: (data: WeiterCreateInput) => WeiterPromise;
  updateWeiter: (args: {
    data: WeiterUpdateInput;
    where: WeiterWhereUniqueInput;
  }) => WeiterPromise;
  updateManyWeiters: (args: {
    data: WeiterUpdateManyMutationInput;
    where?: WeiterWhereInput;
  }) => BatchPayloadPromise;
  upsertWeiter: (args: {
    where: WeiterWhereUniqueInput;
    create: WeiterCreateInput;
    update: WeiterUpdateInput;
  }) => WeiterPromise;
  deleteWeiter: (where: WeiterWhereUniqueInput) => WeiterPromise;
  deleteManyWeiters: (where?: WeiterWhereInput) => BatchPayloadPromise;
...
export interface Subscription {
  ...
  weiter: (
    where?: WeiterSubscriptionWhereInput
  ) => WeiterSubscriptionPayloadSubscription;
}
...
export type WeiterOrderByInput =
  | "id_ASC"
  | "id_DESC"
  | "name_ASC"
  | "name_DESC";
...
export interface WeiterWhereInput {
  id?: Maybe<ID_Input>;
  id_not?: Maybe<ID_Input>;
  id_in?: Maybe<ID_Input[] | ID_Input>;
  id_not_in?: Maybe<ID_Input[] | ID_Input>;
  ...
  name_ends_with?: Maybe<String>;
  name_not_ends_with?: Maybe<String>;
  AND?: Maybe<WeiterWhereInput[] | WeiterWhereInput>;
  OR?: Maybe<WeiterWhereInput[] | WeiterWhereInput>;
  NOT?: Maybe<WeiterWhereInput[] | WeiterWhereInput>;
}
...
export type WeiterWhereUniqueInput = AtLeastOne<{
  id: Maybe<ID_Input>;
}>;
...
export interface WeiterCreateOneInput {
  create?: Maybe<WeiterCreateInput>;
  connect?: Maybe<WeiterWhereUniqueInput>;
}

export interface WeiterCreateInput {
  id?: Maybe<ID_Input>;
  name: String;
}
...
export interface TransactionUpdateWithoutPaymentsDataInput {
  ...
  dateOpen?: Maybe<DateTimeInput>;
  dateClose?: Maybe<DateTimeInput>;
  weiter?: Maybe<WeiterUpdateOneRequiredInput>;
  products?: Maybe<ProductUpdateManyInput>;
}

export interface WeiterUpdateOneRequiredInput {
  create?: Maybe<WeiterCreateInput>;
  update?: Maybe<WeiterUpdateDataInput>;
  upsert?: Maybe<WeiterUpsertNestedInput>;
  connect?: Maybe<WeiterWhereUniqueInput>;
}

export interface WeiterUpdateDataInput {
  name?: Maybe<String>;
}

export interface WeiterUpsertNestedInput {
...
export interface WeiterUpdateInput {
  name?: Maybe<String>;
}

export interface WeiterUpdateManyMutationInput {
  name?: Maybe<String>;
}
...
export interface WeiterSubscriptionWhereInput {
  mutation_in?: Maybe<MutationType[] | MutationType>;
  updatedFields_contains?: Maybe<String>;
  updatedFields_contains_every?: Maybe<String[] | String>;
  updatedFields_contains_some?: Maybe<String[] | String>;
  node?: Maybe<WeiterWhereInput>;
  AND?: Maybe<WeiterSubscriptionWhereInput[] | WeiterSubscriptionWhereInput>;
  OR?: Maybe<WeiterSubscriptionWhereInput[] | WeiterSubscriptionWhereInput>;
  NOT?: Maybe<WeiterSubscriptionWhereInput[] | WeiterSubscriptionWhereInput>;
}
...
export interface WeiterPromise extends Promise<Weiter>, Fragmentable {
  id: () => Promise<ID_Output>;
  name: () => Promise<String>;
}

export interface WeiterSubscription
  extends Promise<AsyncIterator<Weiter>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  name: () => Promise<AsyncIterator<String>>;
}

export interface WeiterNullablePromise
  extends Promise<Weiter | null>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  name: () => Promise<String>;
}
...
export interface WeiterConnection {
  pageInfo: PageInfo;
  edges: WeiterEdge[];
}

export interface WeiterConnectionPromise
  extends Promise<WeiterConnection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<WeiterEdge>>() => T;
  aggregate: <T = AggregateWeiterPromise>() => T;
}

export interface WeiterConnectionSubscription
  extends Promise<AsyncIterator<WeiterConnection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<WeiterEdgeSubscription>>>() => T;
  aggregate: <T = AggregateWeiterSubscription>() => T;
}

export interface WeiterEdge {
  node: Weiter;
  cursor: String;
}

export interface WeiterEdgePromise extends Promise<WeiterEdge>, Fragmentable {
  node: <T = WeiterPromise>() => T;
  cursor: () => Promise<String>;
}

export interface WeiterEdgeSubscription
  extends Promise<AsyncIterator<WeiterEdge>>,
    Fragmentable {
  node: <T = WeiterSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}

export interface AggregateWeiter {
  count: Int;
}

export interface AggregateWeiterPromise
  extends Promise<AggregateWeiter>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateWeiterSubscription
  extends Promise<AsyncIterator<AggregateWeiter>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface WeiterSubscriptionPayload {
  mutation: MutationType;
  node: Weiter;
  updatedFields: String[];
...
export interface WeiterSubscriptionPayloadPromise
  extends Promise<WeiterSubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = WeiterPromise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = WeiterPreviousValuesPromise>() => T;
}

export interface WeiterSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<WeiterSubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = WeiterSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = WeiterPreviousValuesSubscription>() => T;
}

export interface WeiterPreviousValues {
  id: ID_Output;
  name: String;
}

export interface WeiterPreviousValuesPromise
  extends Promise<WeiterPreviousValues>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  name: () => Promise<String>;
}

export interface WeiterPreviousValuesSubscription
  extends Promise<AsyncIterator<WeiterPreviousValues>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  name: () => Promise<AsyncIterator<String>>;
}
